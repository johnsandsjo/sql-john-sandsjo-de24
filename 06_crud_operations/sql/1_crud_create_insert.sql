INSERT
	...
	description)
VALUES ('query',
'requests made to a database to retrive, modify or manaipualt data');
...
INSERT
	...
	description)
VALUES
('CRUD', 'create, read, update, delete - basic actions to be perfomred on data'),
('range condition', 'filter data within a specifc range of values');
